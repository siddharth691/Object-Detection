...
label_placeholder = tf.placeholder(tf.float32, shape = [config.batch_size, config.no_grid, config.no_grid, 5+config.no_classes], name='label_placeholder')
...
predictions = model.yolo_model(image_placeholder, alpha = config.alpha, dropout_rate = config.dropout, is_training= True)
